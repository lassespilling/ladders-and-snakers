(function(global, factory) {
    ...
    var jscolor = function() {
        var jsc = {
            ...
            readyQueue: [],
            register: function() {
                if (typeof window1 !== "undefined" && window1.document) {
                    if (window1.document.readyState !== "loading") jsc.pub.init();
                    else window1.document.addEventListener("DOMContentLoaded", jsc.pub.init, false);
                }
            },
            installBySelector: function(selector, rootNode) {
                ...
                for(var i = 0; i < elms.length; i += 1){
                    if (elms[i].jscolor && elms[i].jscolor instanceof jsc.pub) continue;
            ...
            getInstances: function() {
                var inst = [];
                for(var i = 0; i < jsc.instances.length; i += 1)if (jsc.instances[i] && jsc.instances[i].targetElement) inst.push(jsc.instances[i]);
                return inst;
            },
            ...
            getData: function(obj, prop, setDefault) {
                if (!obj.hasOwnProperty(jsc.dataProp)) {
                    if (setDefault !== undefined) obj[jsc.dataProp] = {};
            ...
            setStyle: function(elm, styles, important, reversible) {
                ...
                for(var prop in styles)if (styles.hasOwnProperty(prop)) {
                    var setVal = null;
                    if (styles[prop] === null) {
                        if (!origStyle) origStyle = jsc.getData(elm, "origStyle");
                        if (origStyle && origStyle.hasOwnProperty(prop)) setVal = origStyle[prop];
                    } else {
                        if (reversible) {
                            if (!origStyle) origStyle = jsc.getData(elm, "origStyle", {});
            ...
            parsePaletteValue: function(mixed) {
                var vals = [];
                if (typeof mixed === "string") mixed.replace(/#[0-9A-F]{3}\b|#[0-9A-F]{6}([0-9A-F]{2})?\b|rgba?\(([^)]*)\)/gi, function(val) {
                    vals.push(val);
                });
            ...
            triggerCallback: function(thisObj, prop) {
                if (!thisObj[prop]) return;
                var callback = null;
                if (typeof thisObj[prop] === "string") try {
            ...
            onDocumentMouseDown: function(e) {
                ...
                if (target.jscolor && target.jscolor instanceof jsc.pub) {
                    ...
                    if (control) jsc.onControlPointerStart(e, target, jsc.getData(target, "control"), "mouse");
                } else if (jsc.picker && jsc.picker.owner) jsc.picker.owner.tryHide();
            },
            ...
            onPaletteSampleClick: function(e) {
                ...
                if (thisObj.format.toLowerCase() === "any") {
                    ...
                    if (!jsc.isAlphaFormat(thisObj.getFormat())) color.rgba[3] = 1;
                }
                if (color.rgba[3] === null) {
                    if (thisObj.paletteSetsAlpha === true || thisObj.paletteSetsAlpha === "auto" && thisObj._paletteHasTransparency) color.rgba[3] = 1;
                }
            ...
            pub: function(targetElement, opts) {
                ...
                this.fromString = function(str, flags) {
                    ...
                    if (this.format.toLowerCase() === "any") {
                        ...
                        if (!jsc.isAlphaFormat(this.getFormat())) color.rgba[3] = 1;
                    }
                ...
                this.hasAlphaChannel = function() {
                    if (this.alphaChannel === "auto") return this.format.toLowerCase() === "any" || jsc.isAlphaFormat(this.getFormat()) || this.alpha !== undefined || this.alphaElement !== undefined;
                    return this.alphaChannel;
                };
                this.processValueInput = function(str) {
                    if (!this.fromString(str)) this.exposeColor();
                };
                this.processAlphaInput = function(str) {
                    if (!this.fromHSVA(null, null, null, parseFloat(str))) this.exposeColor();
                };
                ...
                if (jsc.pub.options) for(var opt in jsc.pub.options){
                ...
                if (opts.preset) {
                    ...
                    else if (Array.isArray(opts.preset)) presetsArr = opts.preset.slice();
                ...
                if (this.container === undefined) this.container = window1.document.body;
                ...
                if (this.valueElement === undefined) {
                    if (jsc.isTextInput(this.targetElement)) this.valueElement = this.targetElement;
                ...
                if (this.previewElement === undefined) this.previewElement = this.targetElement;
                ...
                if (this.value !== undefined) initValue = this.value;
                else if (this.valueElement && this.valueElement.value !== undefined) initValue = this.valueElement.value;
                var initAlpha = undefined;
                if (this.alpha !== undefined) initAlpha = "" + this.alpha;
                else if (this.alphaElement && this.alphaElement.value !== undefined) initAlpha = this.alphaElement.value;
...
//# sourceMappingURL=index.4428f79b.js.map
